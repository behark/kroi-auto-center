        ...
        <section className="bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              ...
              >
                {/* Main Image */}
                <div className="relative aspect-[4/3] md:aspect-video rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-purple-100 to-pink-100 group">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                {car.features?.map((feature, index) => (
                  <motion.div
                    ...
                    className="flex items-center space-x-2 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-3 border border-purple-100"
                  >
                    <Check className="h-5 w-5 text-purple-600 flex-shrink-0" />
                    <span className="text-slate-800">{typeof feature === 'string' ? feature : feature.feature}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
