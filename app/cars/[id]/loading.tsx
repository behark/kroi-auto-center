...
export default function CarDetailLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white" aria-label="Loading car details" role="status">
      {/* Navigation Skeleton */}
      ...
      <section className="pb-8 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            {/* Image Skeleton */}
            <div className="h-[300px] md:h-[400px] lg:h-[500px] bg-slate-200 rounded-2xl animate-pulse" />

            {/* Info Skeleton */}
            <div className="space-y-6">
              <div>
                <div className="h-12 w-3/4 bg-slate-200 rounded mb-4 animate-pulse" />
                <div className="h-6 w-full bg-slate-200 rounded animate-pulse" />
              </div>

              <div className="bg-slate-100 rounded-xl p-6">
                <div className="h-12 w-48 bg-slate-200 rounded mb-4 animate-pulse" />
